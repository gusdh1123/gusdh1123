...
- 👨‍💻 팀 프로젝트에서 게시글 CRUD, 기반 소셜 로그인(OAuth 2.0), Ajax 댓글·대댓글, 좋아요·팔로우·북마크 등 핵심 기능을 직접 구현했습니다.
- ☁️ AWS EC2(Ubuntu)에 Docker로 Oracle DB 컨테이너를 구성하고, 같은 EC2 서버에 Tomcat을 설치해 Spring Boot WAR 파일을 배포하며 기본적인 배포 경험을 쌓았습니다.
