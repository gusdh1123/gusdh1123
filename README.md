...
|--------|-------------|-------|
| 🛋️ [**내일의 집(커뮤니티 기반 인테리어 쇼핑몰 플랫폼)**](https://github.com/gusdh1123/naeilhome) | 게시글 CRUD, 소셜 로그인, 마이페이지, 찜하기 등 커뮤니티 + 쇼핑몰 기능 구현 | Java, Spring Boot, MyBatis, Oracle, AWS, Docker |
